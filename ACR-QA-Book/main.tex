...
\newcommand{\chapterdivider}[2]{%
  ...
  \vspace*{\fill}
  \begin{center}
    {\fontsize{26}{30}\selectfont\bfseries\color{KSIUNavy} CHAPTER (#1)}\\[24pt]
    {\color{KSIUGold}\rule{0.55\textwidth}{1.5pt}}\\[24pt]
    {\fontsize{42}{50}\selectfont\bfseries\color{KSIUNavy} #2}
  \end{center}
  \vspace*{\fill}
  \clearpage
}
