...
\newcommand{\chapterdivider}[2]{%
  ...
  \vspace*{\fill}
  \begin{center}
    {\fontsize{30}{36}\selectfont\bfseries\color{KSIUNavy} CHAPTER (#1)}\\[28pt]
    {\color{KSIUGold}\rule{0.60\textwidth}{2.0pt}}\\[28pt]
    {\fontsize{52}{62}\selectfont\bfseries\color{KSIUNavy} #2}
  \end{center}
  \vspace*{\fill}
  \clearpage
}
