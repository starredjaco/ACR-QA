...
\newcommand{\chapterdivider}[2]{%
  ...
  \vspace*{\fill}
  \begin{center}
    {\fontsize{22}{26}\selectfont\bfseries\color{KSIUNavy} CHAPTER (#1)}\\[22pt]
    {\color{KSIUGold}\rule{0.55\textwidth}{1.5pt}}\\[22pt]
    {\fontsize{36}{44}\selectfont\bfseries\color{KSIUNavy} #2}
  \end{center}
  \vspace*{\fill}
  \clearpage
}
