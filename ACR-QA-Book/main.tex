...
\newcommand{\chapterdivider}[2]{%
  ...
  \vspace*{\fill}
  \begin{center}
    {\fontsize{24}{30}\selectfont\bfseries\color{KSIUNavy} Chapter #1}\\[20pt]
    {\color{KSIUNavy}\rule{0.50\textwidth}{1.0pt}}\\[20pt]
    \parbox{0.75\textwidth}{\centering\fontsize{34}{46}\selectfont\bfseries #2}
  \end{center}
  \vspace*{\fill}
  \clearpage
}
