...
\begin{table}[htbp]
\caption{Open-Source SAST Tools Surveyed and Selected for \ACRQA{} (Tools actually integrated in v3.2.4 shown in bold)}
...
This chapter has reviewed the state of the art in static analysis, AI-assisted code review, retrieval-augmented generation, and cryptographic inventory, establishing the knowledge base upon which \ACRQA{} is built. The identified gaps confirm that a self-hosted, multi-tool, AI-augmented platform with label-free confidence scoring, entropy-based consistency validation, and PQC-aware CBoM generation represents a meaningful and novel contribution to the field.
