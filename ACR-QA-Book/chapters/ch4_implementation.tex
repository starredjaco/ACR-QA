...
\begin{table}[H]
\caption{Core Technology Stack (v5.0.0rc1)}
...
\begin{lstlisting}[language={}, basicstyle=\footnotesize\ttfamily, caption={Repository Directory Structure (v5.0.0rc1)}]
acr-qa/
├── CORE/
...
This chapter has documented the implementation of \ACRQA{} v5.0.0rc1, covering the FastAPI REST layer (52 endpoints), Celery asynchronous workers, language adapters, taint analyser, call-graph reachability engine, confidence scorer, RAG knowledge base, entropy filter, CBoM scanner, React dashboard, Docker Compose deployment, GitHub PR integration, authentication layer, and the four new v5.0.0 engines (Heuristic Risk Predictor, Time-Travel Analyzer, IaC Scanner, PR Risk Score). Chapter~\ref{ch:testing} presents the testing strategy and quantitative evaluation results.
