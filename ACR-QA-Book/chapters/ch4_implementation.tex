...
\begin{table}[H]
\caption{Core Technology Stack (v4.0.0)}
...
\midrule
API Server          & FastAPI 0.115 + Uvicorn   & 32 async REST endpoints; Pydantic v2 validation \\
...
\begin{lstlisting}[language={}, basicstyle=\footnotesize\ttfamily, caption={Repository Directory Structure (v4.0.0)}]
acr-qa/
├── CORE/
...
├── FRONTEND/api/            # FastAPI (32 endpoints)
