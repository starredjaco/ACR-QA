...
\begin{figure}[htbp]
  ...
  \caption{High-Level Architecture of the \ACRQA{} System (v5.0.0rc1)}
...
\begin{table}[H]
\caption{Tool Execution Mapping and Typical Runtime (v5.0.0rc1)}
...
\begin{table}[H]
\caption{Principal FastAPI REST Endpoints (v5.0.0rc1)}
