...
**Active progress (v5.0.0b1):** Phase A Weeks 1 ✅ + 2 ✅ + 3 ✅ + 4 ✅ + 5 ✅ shipped on `main`. Tests **2,653**. Endpoints **52**. Migrations **18**. Ground-truth YAMLs **23** (CVE recall battery **20** pre-registered). Week A6 = defense polish only.
