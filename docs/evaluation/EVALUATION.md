...
| Code Coverage | ✅ ~39% overall, 53-92% core modules |
...
*Repos tested: DVPWA, Flask, FastAPI, Rich, Requests, Arrow, Marshmallow, Paramiko, Fabric, Celery, Pydantic, Scrapy, httpbin, httpie, + 2 others*
