...
|------------|:--------:|:--:|:--:|:---------:|:--:|
| DVPWA | 43 | 16 | 27 | 37.2% | 54.2% |
| Pygoat | 425 | 239 | 186 | 56.2% | 72.0% |
| VulPy | 276 | 119 | 157 | 43.1% | 60.2% |
| DSVW | 53 | 20 | 33 | 37.7% | 54.8% |
...
**Ground Truth Recall: 67%** (4/6 known vulnerability categories detected)
...
**Noise Reduction: -23%** — ACR-QA's normalization + dedup pipeline eliminated -8 redundant findings.
