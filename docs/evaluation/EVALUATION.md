...
> *(Fill in after running the comparison — these will be the key differentiator numbers in the thesis)*

| Repo | Stars | JS Files | ACR-QA Findings | H/M/L | Key Issues Found |
|------|-------|---------|----------------|-------|-----------------|
| DVNA | 900+ | _TBD_ | _TBD_ | _TBD_ | eval injection, SQLi, hardcoded secrets |
| NodeGoat | 1.9k | _TBD_ | _TBD_ | _TBD_ | XSS, prototype pollution, JWT |

---

*Generated by ACR-QA Evaluation Suite — April 5, 2026 (v3.0.1)*
