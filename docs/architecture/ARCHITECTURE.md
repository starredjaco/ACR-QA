...
| Dashboard | `FRONTEND/api/main.py` + `FRONTEND/static/ui/` | FastAPI (84 endpoints) + React 18 SPA + 13-page static HTML UI (landing + auth UX + demo mode) |
