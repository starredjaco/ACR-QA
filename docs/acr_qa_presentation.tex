...
\begin{frame}[plain]
  \vspace{1.0cm}
  \centering
  \IfFileExists{media/ksiu-logo.png}{\includegraphics[height=1.5cm]{media/ksiu-logo.png}\\[0.5em]}{}
  ...
  \begin{columns}[T]
    \begin{column}{0.65\textwidth}
      ...
      \begin{itemize}\setlength\itemsep{0.6em}
        ...
        \item Uses Cerebras AI + RAG (Retrieval-Augmented Generation).
    ...
    \begin{column}{0.35\textwidth}
      \begin{tcolorbox}[colback=acrLight,colframe=acrBlue,title=\textbf{Core Stack}]
        \scriptsize \symCode{} FastAPI\\ \symDB{} PostgreSQL/Redis\\ \symBrain{} Cerebras AI\\ \symCI{} GitHub Actions
      \end{tcolorbox}
    \end{column}
  \end{columns}
\end{frame}
