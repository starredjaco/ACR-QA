...
**Key numbers:** 97.1% precision · 9/10 OWASP Top 10 · **2,653 tests** (2,549 Python + 104 TypeScript) · 52 async API endpoints · 18 Alembic migrations · 327+ rule mappings (incl. 28 IaC) · **71.2% recall = Semgrep CE** (13-repo head-to-head) · $0 recurring cost
